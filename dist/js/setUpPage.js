import { categories, CategoryIdEnum } from "./database.js";
var url = window.location.href;
var categoriesLoaded = localStorage.getItem("categories") ? JSON.parse(localStorage.getItem("categories")) : categories;
var categorias = [];
...
categorias.forEach(function (category) { return category.recipes.forEach(function (recipe) {
    var _a;
